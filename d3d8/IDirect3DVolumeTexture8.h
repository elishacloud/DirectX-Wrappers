...
class m_IDirect3DVolumeTexture8 : public IDirect3DVolumeTexture8
{
private:
	LPDIRECT3DVOLUMETEXTURE8 m_pD3DVolumeTexture8;

public:
	m_IDirect3DVolumeTexture8(LPDIRECT3DVOLUMETEXTURE8 pTexture8) { m_pD3DVolumeTexture8 = pTexture8; }
