...
{
private:
	IDirectInputDevice2W *ProxyInterface;

public:
	m_IDirectInputDevice2W(IDirectInputDevice2W *aOriginal, void *temp) : ProxyInterface(aOriginal)
	{
	...
	IDirectInputDevice2W *GetProxyInterface() { return ProxyInterface; }
