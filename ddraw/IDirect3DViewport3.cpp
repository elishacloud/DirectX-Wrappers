...
m_IDirect3DViewport3::m_IDirect3DViewport3(IDirect3DViewport3 * aOriginal)
{
...
HRESULT __stdcall m_IDirect3DViewport3::QueryInterface(REFIID riid, LPVOID * ppvObj)
{
...
ULONG __stdcall m_IDirect3DViewport3::AddRef()
{
...
ULONG __stdcall m_IDirect3DViewport3::Release()
{
...
HRESULT __stdcall m_IDirect3DViewport3::Initialize(LPDIRECT3D a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::GetViewport(LPD3DVIEWPORT a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::SetViewport(LPD3DVIEWPORT a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::TransformVertices(DWORD a, LPD3DTRANSFORMDATA b, DWORD c, LPDWORD d)
{
...
HRESULT __stdcall m_IDirect3DViewport3::LightElements(DWORD a, LPD3DLIGHTDATA b)
{
...
HRESULT __stdcall m_IDirect3DViewport3::SetBackground(D3DMATERIALHANDLE a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::GetBackground(LPD3DMATERIALHANDLE a, LPBOOL b)
{
...
HRESULT __stdcall m_IDirect3DViewport3::SetBackgroundDepth(LPDIRECTDRAWSURFACE a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::GetBackgroundDepth(LPDIRECTDRAWSURFACE * a, LPBOOL b)
{
...
HRESULT __stdcall m_IDirect3DViewport3::Clear(DWORD a, LPD3DRECT b, DWORD c)
{
...
HRESULT __stdcall m_IDirect3DViewport3::AddLight(LPDIRECT3DLIGHT a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::DeleteLight(LPDIRECT3DLIGHT a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::NextLight(LPDIRECT3DLIGHT a, LPDIRECT3DLIGHT * b, DWORD c)
{
...
HRESULT __stdcall m_IDirect3DViewport3::GetViewport2(LPD3DVIEWPORT2 a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::SetViewport2(LPD3DVIEWPORT2 a)
{
...
HRESULT __stdcall m_IDirect3DViewport3::SetBackgroundDepth2(LPDIRECTDRAWSURFACE4 a)
{
	logf("IDirect3DViewport3::SetBackgroundDepth2(LPDIRECTDRAWSURFACE4 0x%x);", a);
	HRESULT x = mOriginal->SetBackgroundDepth2((a) ? ((m_IDirectDrawSurface4 *)a)->mOriginal : 0);
	logf(" -> return %d\n", x);
	return x;
}

HRESULT __stdcall m_IDirect3DViewport3::GetBackgroundDepth2(LPDIRECTDRAWSURFACE4 * a, LPBOOL b)
{
	...
	logf(" -> return %d\n", x);
	m_IDirectDrawSurface4 * n = (m_IDirectDrawSurface4 *)wrapfetch(*a);
	if (n == NULL && *a != NULL)
	{
		n = (m_IDirectDrawSurface4 *)new m_IDirectDrawSurface4(*a);
		wrapstore(n, *a);
		logf("Wrapped.\n");
	}
	*a = n;
...
HRESULT __stdcall m_IDirect3DViewport3::Clear2(DWORD a, LPD3DRECT b, DWORD c, D3DCOLOR d, D3DVALUE e, DWORD f)
{
