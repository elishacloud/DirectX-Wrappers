...
class m_IDirectSoundFXCompressor8 : public IDirectSoundFXCompressor8, public AddressLookupTableObject
{
private:
	LPDIRECTSOUNDFXCOMPRESSOR8 ProxyInterface;

public:
	m_IDirectSoundFXCompressor8(LPDIRECTSOUNDFXCOMPRESSOR8 pSound8, void *temp) : ProxyInterface(pSound8)
	{
